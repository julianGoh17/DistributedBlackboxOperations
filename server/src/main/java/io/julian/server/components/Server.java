...
public class Server {
    ...
    private final static String[] OPERATION_IDS = new String[]{"postMessage", "getMessage", "putMessage", "deleteMessage",
    ...
    public void addHandlers(final Vertx vertx) {
        ...
        List<AbstractServerHandler> handlers = Arrays.asList(postMessageHandler, putMessageHandler, getMessageHandler,
            deleteMessageHandler, coordinationMessageHandler, labelHandler);
        // Gate Handlers
